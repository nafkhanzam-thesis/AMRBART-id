...
entries = get_entries(f"/home/nafkhanzam/kode/nafkhanzam/thesis/AMRBART-v3/outputs/infer-mbart-en-id-smaller-pre-trained-fine-tune/val_outputs/test_generated_predictions_0.txt")
...
pred = [LABELS[1] if x > 0.476190 else LABELS[0] for x in results]
