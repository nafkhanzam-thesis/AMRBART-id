...
args = Namespace(
  ...
  model_name_or_path='../models/tiny-random-mbart',
  model_type='../models/tiny-random-mbart',
  max_steps=300000,
  no_cache=False,
  no_cuda=False,
  num_train_epochs=1000.0,
  output_dir='../outputs/amrbart-akreal-tiny-random-mbart-Unifiedtextinf-JointDenoise-6task-5e-5-AMREOS',
